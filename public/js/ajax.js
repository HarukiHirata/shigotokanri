...
/* WEBPACK VAR INJECTION */(function($) {$('.attendance-search-form .search-btn').on('click', function () {
  ...
  $.ajax({
    ...
    if (data.length === 0) {
      ...
      $.each(data, function (index, value) {
        ...
        html = "\n                    <table>\n                        <tr class=\"attendance-list\">\n                            <td class=\"col-md-4\">".concat(date, "</td>\n                            <td class=\"col-md-2\">").concat(start_time, "</td>\n                            <td class=\"col-md-2\">").concat(end_time, "</td>\n                            <td class=\"col-md-2\">").concat(break_time, "</td>\n                        </tr>\n                    </table>\n                    ");
      });
    }
...
module.exports = __webpack_require__(/*! /var/www/html/shigotokanri/resources/js/ajax.js */"./resources/js/ajax.js");
